...
public class agregarProovedor extends JInternalFrame {
	...
	public agregarProovedor() {
			...
			public void actionPerformed(ActionEvent e) {
				if (inputNombre.getText().isEmpty() || inptCodigo.getText().isEmpty()) {
					...
					if (controlador.getModelo().codigoRepetido(inptCodigo.getText())
							|| controlador.getModelo().nombreRepetido(inputNombre.getText())) {
		...
		groupLayout.setHorizontalGroup(groupLayout.createParallelGroup(Alignment.LEADING)
				.addGroup(groupLayout.createSequentialGroup().addGap(31).addComponent(panel, GroupLayout.PREFERRED_SIZE,
				...
				.addGroup(groupLayout.createSequentialGroup().addGap(10).addComponent(inputNombre,
						GroupLayout.PREFERRED_SIZE, 158, GroupLayout.PREFERRED_SIZE))
				.addGroup(groupLayout.createSequentialGroup().addGap(10).addComponent(lblNewLabel_2))
				.addGroup(groupLayout.createSequentialGroup().addGap(10).addComponent(inptCodigo,
						GroupLayout.PREFERRED_SIZE, 158, GroupLayout.PREFERRED_SIZE))
				.addGroup(groupLayout.createSequentialGroup().addGap(29).addComponent(btnAgregarProovedor).addGap(31)
						.addComponent(btnCancelar)));
		groupLayout.setVerticalGroup(groupLayout.createParallelGroup(Alignment.LEADING).addGroup(groupLayout
				.createSequentialGroup()
				.addComponent(panel, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
				.addGap(6).addComponent(lblNewLabel).addGap(6)
				.addComponent(inputNombre, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
						GroupLayout.PREFERRED_SIZE)
				.addGap(6).addComponent(lblNewLabel_2).addGap(6)
				.addComponent(inptCodigo, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
						GroupLayout.PREFERRED_SIZE)
				.addGap(6).addGroup(groupLayout.createParallelGroup(Alignment.LEADING).addComponent(btnAgregarProovedor)
						.addComponent(btnCancelar))));
